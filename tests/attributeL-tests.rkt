...
(test-equal (result-adaptation (apply-reduction-relation* expr-red (term ((+ 314159 4) ()))))
...
(test-equal (result-adaptation (apply-reduction-relation* expr-red (term ((- 7 314159) ()))))
...
(test-equal (result-adaptation (apply-reduction-relation* expr-red (term ((== 64 640) ()))))
            (judgment-holds (eval () (== 64 640) value) value))
(test-equal (result-adaptation (apply-reduction-relation* expr-red (term ((> 3 45) ()))))
...
(test-equal (result-adaptation (apply-reduction-relation* expr-red (term ((> 45 3) ()))))
...
(test-equal (result-adaptation (apply-reduction-relation* expr-red (term ((+ x0 x1) ((x0 2718281828) (x1 1))))))
...
(test-equal (result-adaptation (apply-reduction-relation* expr-red (term ((- x0 x1) ((x0 15) (x1 2718281828))))))
